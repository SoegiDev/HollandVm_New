...
const ModalCart = (props) => {
  ...
  const handleModalBeli = (props) => {
    requstPayment(props);
  };
  const handleModalConfirm = (props) => {
    batalkanKeranjang(props);
  };
  const handleBatalkanKeranjang = (props) => {
            ...
            <ul>
              {transactions.map((item, index) => (
                <MyItems
                  key={index}
                  Data={item}
                  handleBatalkanKeranjang={handleBatalkanKeranjang}
                ...
                <div className="flex flex-col items-center mt-12">
                  <button className="w-full ml-4 mr-4 mt-2 mb-4 bg-hollandtints-800 text-white transition duration-500 rounded-2xl hover:opacity-80 hover:shadow-lg">
                    <span
                      ...
                      onClick={() => {
                        handleBatalkanKeranjang({ transactions: transactions });
                      }}
                    >
      ...
      <div className="flex h-max[192px] w-full">
        ...
        <div className="flex flex-col w-full mt-4 mr-4">
          ...
          <div className="flex ml-2 mt-4">
            ...
            >
              {Data.status_promo ? numberFormat(Data.harga_jual) : ""}
            </p>
          </div>
